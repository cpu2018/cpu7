...
sgn2828:
	lis	r31, lo16(l5915)
	srwi	r31, r31, 31
	addi	r31, r31, ha16(l5915)
	slwi	r31, r31, 16
	addi	r31, r31, lo16(l5915)
	lfd	f1, 0(r31)
	fcmpu	cr7, f0, f1
	bne	cr7, beq_else6179
	lis	r31, lo16(l5915)
	srwi	r31, r31, 31
	addi	r31, r31, ha16(l5915)
	slwi	r31, r31, 16
...
beq_else6179:
	...
	lfd	f1, 0(r31)
	fcmpu	cr7, f0, f1
	bgt	cr7, ble_else6180
	lis	r31, lo16(l5917)
	srwi	r31, r31, 31
	addi	r31, r31, ha16(l5917)
	slwi	r31, r31, 16
	addi	r31, r31, lo16(l5917)
	lfd	f0, 0(r31)
	blr
ble_else6180:
	lis	r31, lo16(l5916)
	srwi	r31, r31, 31
	addi	r31, r31, ha16(l5916)
	slwi	r31, r31, 16
	addi	r31, r31, lo16(l5916)
	lfd	f0, 0(r31)
	blr
vecunit_sgn2854:
	lfd	f0, 0(r2)
...
rad2953:
	lis	r31, lo16(l5930)
	srwi	r31, r31, 31
	addi	r31, r31, ha16(l5930)
	slwi	r31, r31, 16
	addi	r31, r31, lo16(l5930)
	lfd	f1, 0(r31)
	fmul	f0, f0, f1
	blr
read_screen_settings2955:
	...
	lis	r31, lo16(l5934)
	srwi	r31, r31, 31
	addi	r31, r31, ha16(l5934)
	slwi	r31, r31, 16
	addi	r31, r31, lo16(l5934)
	lfd	f3, 0(r31)
	fmul	f2, f2, f3
	stfd	f2, 0(r2)
	lis	r2, lo16(min_caml_screenz_dir)
	...
	lis	r31, lo16(l5936)
	srwi	r31, r31, 31
	addi	r31, r31, ha16(l5936)
	slwi	r31, r31, 16
	addi	r31, r31, lo16(l5936)
	lfd	f2, 0(r31)
	lfd	f3, 16(r3)
	fmul	f2, f3, f2
	stfd	f2, 4(r2)
...
rotate_quadratic_matrix2959:
	...
	lis	r31, lo16(l5970)
	srwi	r31, r31, 31
	addi	r31, r31, ha16(l5970)
	slwi	r31, r31, 16
	addi	r31, r31, lo16(l5970)
	lfd	f12, 0(r31)
	fmul	f13, f5, f6
	fmul	f13, f13, f8
	fmul	f14, f7, f10
...
beq_else6196:
	cmpwi	cr7, r8, 2
	bne	cr7, beq_else6204
	lwz	r5, 28(r3)
	cmpwi	cr7, r5, 0
	bne	cr7, beq_else6206
	li	r5, 1
	b	beq_cont6207
beq_else6206:
	li	r5, 0
...
beq_else6208:
	...
	stw	r31, 76(r3)
	addi	r3, r3, 80
	bl	rotate_quadratic_matrix2959
	subi	r3, r3, 80
	lwz	r31, 76(r3)
	mtlr	r31
beq_cont6209:
...
bge_else6210:
	...
	stw	r31, 4(r3)
	addi	r3, r3, 8
	bl	read_nth_object2962
	subi	r3, r3, 8
	lwz	r31, 4(r3)
	mtlr	r31
	cmpwi	cr7, r2, 0
	bne	cr7, beq_else6212
...
beq_else6216:
	...
	stwx	r2, r5, r7
	addi	r2, r6, 1
	b	read_and_network2972
read_parameter2974:
	mflr	r31
	stw	r31, 4(r3)
	addi	r3, r3, 8
	bl	read_screen_settings2955
	subi	r3, r3, 8
	lwz	r31, 4(r3)
	mtlr	r31
	mflr	r31
...
rt3317:
	...
	lis	r31, lo16(l6062)
	srwi	r31, r31, 31
	addi	r31, r31, ha16(l6062)
	slwi	r31, r31, 16
	addi	r31, r31, lo16(l6062)
	lfd	f0, 0(r31)
	itof	f1, r2
	fdiv	f0, f0, f1
	stfd	f0, 0(r5)
