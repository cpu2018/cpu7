...
_min_caml_start:
	...
	lis	r31, lo16(l74)
	srwi	r31, r31, 31
	addi	r31, r31, ha16(l74)
	slwi	r31, r31, 16
	addi	r31, r31, lo16(l74)
	lfd	f1, 0(r31)
	stfd	f0, 0(r3)
	mflr	r31
	fmr	f0, f1
	...
	lis	r31, lo16(l75)
	srwi	r31, r31, 31
	addi	r31, r31, ha16(l75)
	slwi	r31, r31, 16
	addi	r31, r31, lo16(l75)
	lfd	f2, 0(r31)
	stfd	f0, 8(r3)
	stfd	f1, 16(r3)
	mflr	r31
	...
	lis	r31, lo16(l76)
	srwi	r31, r31, 31
	addi	r31, r31, ha16(l76)
	slwi	r31, r31, 16
	addi	r31, r31, lo16(l76)
	lfd	f2, 0(r31)
	stfd	f0, 24(r3)
	stfd	f1, 32(r3)
	mflr	r31
	...
	lis	r31, lo16(l77)
	srwi	r31, r31, 31
	addi	r31, r31, ha16(l77)
	slwi	r31, r31, 16
	addi	r31, r31, lo16(l77)
	lfd	f2, 0(r31)
	stfd	f0, 40(r3)
	stfd	f1, 48(r3)
	mflr	r31
	...
	lis	r31, lo16(l78)
	srwi	r31, r31, 31
	addi	r31, r31, ha16(l78)
	slwi	r31, r31, 16
	addi	r31, r31, lo16(l78)
	lfd	f2, 0(r31)
	stfd	f0, 56(r3)
	stfd	f1, 64(r3)
	mflr	r31
