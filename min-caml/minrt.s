...
neighbors_exist.2833:
	...
	addi	r8, r5, 1
	cmpw	cr7, r7, r8
	bgt	cr7, ble_else.8044
	li	r2, 0
	blr
ble_else.8044:
	cmpwi	cr7, r5, 0
	bgt	cr7, ble_else.8045
	li	r2, 0
	blr
ble_else.8045:
	lwz	r5, 0(r6)
