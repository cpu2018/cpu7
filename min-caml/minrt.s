...
l.5123:	 # 0.000000
	...
	.align 2
# ------------------------------ „Åì„Åì„Åã„Çâ„É©„Ç§„Éñ„É©„É™ ------------------------------
min_caml_print_int:
	mflr	r31 # „É™„É≥„ÇØ„É¨„Ç∏„Çπ„Çø„ÅÆÂÄ§„Çír31„Å´‰∏ÄÊôÇÊ†ºÁ¥ç
	stw	r31, 4(r3) # Ê†ºÁ¥ç„Åï„Çå„Åü„É™„É≥„ÇØ„É¨„Ç∏„Çπ„Çø„ÅÆÂÄ§„Çí„Çπ„Çø„ÉÉ„ÇØ„Å´Á©ç„ÇÄ
	addi	r3, r3, 8 # „Çπ„Çø„ÉÉ„ÇØ„Éù„Ç§„É≥„Çø„ÇíÊõ¥Êñ∞„Åô„Çã
	stw	r2, 4(r3)
	addi	r3, r3, 8
	stw	r5, 4(r3)
	addi	r3, r3, 8
	...
	stw	r12, 4(r3)
	addi	r3, r3, 8
	li	r10, 10 # r10„Å´10„Çí„Çª„ÉÉ„Éà
	li	r6, 4
	bl	print_int
	subi	r3, r3, 8
	lwz	r12, 4(r3)
	...
	mtlr	r31
print_int:
	mr	r5, r2 # Ëª¢ÈÄÅ„Åô„ÇãÊï∞„ÅÆÂÖ®‰Ωì„Çír5„Å´ÂÖ•„Çå„Çã:Ê¨°„ÅÆÂâ≤„Çâ„Çå„ÇãÊï∞„Çí„Çª„ÉÉ„Éà
	li	r2, 0 # ÂïÜ„Çí„É™„Çª„ÉÉ„Éà
	add	r9, r9, r6 # Ê≥®ÁõÆ„Åô„ÇãÊúÄÂ§ßÊ°Å„Çí„Çª„ÉÉ„Éà
#	„Çµ„Éñ„É´„Éº„ÉÅ„É≥q2r7„ÇíÂëº„Å≥Âá∫„Åô
	mflr	r31
	stw	r31, 4(r3)
	addi	r3, r3, 8
	bl	q2r7
	...
	lwz	r31, 4(r3)
	mtlr	r31
#	„Çµ„Éñ„É´„Éº„ÉÅ„É≥q2r7„Åã„ÇâÊàª„Çã
	addi	r11, r7, 48 # ascii„Å´Â§âÊèõ r11„ÅØ2Áï™ÁõÆ„Å´Ë°®Á§∫„Åô„Çã
	cmpwi	cr7, r6, 4 # „ÇÇ„Åór6 = 4„Å™„Çâ„Å∞„ÄÅr6 - 3„Çí„Åó„Å¶Á∂ôÁ∂ö
	bne	r61or0
	addi	r12, r7, 48 # ascii„Å´Â§âÊèõ r12„ÅØ3Áï™ÁõÆ„Å´Ë°®Á§∫„Åô„ÇãÂÄ§
	subi	r6, r6, 3
#	„Çµ„Éñ„É´„Éº„ÉÅ„É≥ÁöÑ„Å´print_int„ÇíÂëº„Å≥Âá∫„Åô „Åì„Åì„ÅßÂëº„Å≥Âá∫„Åôprint_int„ÅØr6eq1or0„Å´ÂÖ•„Çã
	mflr	r31
	stw	r31, 4(r3)
	addi	r3, r3, 8
	bl	print_int
	...
	lwz	r31, 4(r3)
	mtlr	r31
#	„Çµ„Éñ„É´„Éº„ÉÅ„É≥ÁöÑ„Å´print_int„Åã„ÇâÊàª„Çã
	out	r12
	blr
r61or0:
	cmpwi	cr7, r6, 1
	bne	r6eq0
	subi	r6, r6, 1
#	„Çµ„Éñ„É´„Éº„ÉÅ„É≥ÁöÑ„Å´print_int„ÇíÂëº„Å≥Âá∫„Åô „Åì„ÅìÂëº„Å≥Âá∫„Åôprint_int„ÅØr6eq0„Åæ„Åß„ÅÑ„Åè
	mflr	r31
	stw	r31, 4(r3)
	addi	r3, r3, 8
	bl	print_int
...
r6eq0:
	...
	out	r7
	blr
q2r7: # Ââ≤„ÇäÁÆó„ÄÇÂïÜ„ÅØr2„ÄÅ‰Ωô„Çä„ÅØr7„Å∏
	slw	r8, r10, r9 # Âºï„ÅÑ„Å¶„Åø„ÇãÂÄ§„Çí„Çª„ÉÉ„Éà
	sub	r8, r5, r8 # „Å®„Çä„ÅÇ„Åà„ÅöÂºï„ÅÑ„Å¶„Åø„Çã
	cmpwi	cr7, r8, 0 # Âºï„Åã„Çå„ÅüÂÄ§„Åå0Êú™Ê∫Ä„Åã„Å©„ÅÜ„Åã„ÇíÂà§ÂÆö„Åô„Çã
	blt	idle # Ë≤†„ÅÆÊï∞„Å™„Çâ„Å∞„ÄÅ‰Ωï„ÇÇ„Åó„Å™„ÅÑ(idle)„Å∏,
	mr	r5, r8 # Âºï„ÅèÂ†¥ÂêàÊ¨°„Å´Ââ≤„Çâ„Çå„ÇãÂÄ§„ÇíÊõ¥Êñ∞
	li	r8, 1 # Ë∂≥„ÅôÂÄ§„Çí‰ΩúÊàê
	slw	r8, r8, r9 # 1„ÇíÊ≥®ÁõÆ„Åô„ÇãÊ°Å„Åæ„Åß„Ç∑„Éï„Éà
	add	r2, r2, r8 # ÂïÜ„ÇíÊõ¥Êñ∞
	cmpwi	cr7, r9, 0 # Ê≥®ÁõÆ„Åô„ÇãÊ°Å„Åå0„Åæ„ÅßË°å„Å£„Åü„Åã„Å©„ÅÜ„Åã
	bgt	cr7, r9eq0 # „Åæ„Å†0„Å´„Å™„Å£„Å¶„ÅÑ„Å™„Åã„Å£„Åü„Çâ„Åæ„Å†Ââ≤„Çå„Çã„ÅÆ„Åß„ÄÅq2r7„Å´„ÇÇ„Å©„Çã
	subi	r9, r9, 1 # 0„Åæ„ÅßË°å„Å£„Å¶„Å™„ÅÑ„Å™„Çâ„Å∞„ÄÅ„Éá„ÇØ„É™„É°„É≥„Éà
	b	q2r7
idle: #Âºï„Åã„Å™„ÅÑÂ†¥Âêà:Ê¨°„Å´Ââ≤„Çâ„Çå„ÇãÂÄ§„ÅØ„Åù„ÅÆ„Åæ„Åæ„ÄÅÂïÜ„Å´„ÇÇ‰Ωï„ÇÇ„Åü„Åï„Å™„ÅÑ
	cmpwi	cr7, r9, 0
	bgt	cr7, r9eq0 # 
	subi	r9, r9, 1
	b	q2r7
...
bge_else.7815:
	...
	stw	r6, 4(r3)
	stw	r2, 8(r3)
	mflr	r31 # •Í•Û•Ø•Ï•∏•π•ø§Œ√Õ§Úr31§À∞Ïª˛≥ «º
	mr	r30, r5
	stw	r31, 12(r3) # ≥ «º§µ§Ï§ø•Í•Û•Ø•Ï•∏•π•ø§Œ√Õ§Ú•π•ø•√•Ø§À¿—§‡
	addi	r3, r3, 16 # •π•ø•√•Ø•›•§•Û•ø§Úππø∑
	lwz	r31, 0(r30)
	mtctr	r31
	bctrl
	subi	r3, r3, 16
...
read_parameter.2610:
	...
	mflr	r31 # •Í•Û•Ø•Ï•∏•π•ø§Œ√Õ§Úr31§À∞Ïª˛≥ «º
	mr	r30, r2
	stw	r31, 20(r3) # ≥ «º§µ§Ï§ø•Í•Û•Ø•Ï•∏•π•ø§Œ√Õ§Ú•π•ø•√•Ø§À¿—§‡
	addi	r3, r3, 24 # •π•ø•√•Ø•›•§•Û•ø§Úππø∑
	lwz	r31, 0(r30)
	mtctr	r31
	bctrl
	subi	r3, r3, 24
...
solver_rect.2621:
	...
	stw	r30, 32(r3)
	mflr	r31 # •Í•Û•Ø•Ï•∏•π•ø§Œ√Õ§Úr31§À∞Ïª˛≥ «º
	stw	r31, 36(r3) # ≥ «º§µ§Ï§ø•Í•Û•Ø•Ï•∏•π•ø§Œ√Õ§Ú•π•ø•√•Ø§À¿—§‡
	addi	r3, r3, 40 # •π•ø•√•Ø•›•§•Û•ø§Úππø∑
	lwz	r31, 0(r30)
	mtctr	r31
	bctrl
	subi	r3, r3, 40
...
beq_else.7946:
	...
	fmr	f0, f1
	fmr	f1, f31
	stw	r31, 52(r3) # ≥ «º§µ§Ï§ø•Í•Û•Ø•Ï•∏•π•ø§Œ√Õ§Ú•π•ø•√•Ø§À¿—§‡
	addi	r3, r3, 56 # •π•ø•√•Ø•›•§•Û•ø§Úππø∑
	lwz	r31, 0(r30)
	mtctr	r31
	bctrl
	subi	r3, r3, 56
...
beq_else.7952:
	...
	mr	r30, r6
	mr	r6, r10
	stw	r31, 28(r3) # ≥ «º§µ§Ï§ø•Í•Û•Ø•Ï•∏•π•ø§Œ√Õ§Ú•π•ø•√•Ø§À¿—§‡
	addi	r3, r3, 32 # •π•ø•√•Ø•›•§•Û•ø§Úππø∑
	lwz	r31, 0(r30)
	mtctr	r31
	bctrl
	subi	r3, r3, 32
...
beq_else.7969:
	...
	fmr	f1, f2
	fmr	f2, f3
	stw	r31, 100(r3) # ≥ «º§µ§Ï§ø•Í•Û•Ø•Ï•∏•π•ø§Œ√Õ§Ú•π•ø•√•Ø§À¿—§‡
	addi	r3, r3, 104 # •π•ø•√•Ø•›•§•Û•ø§Úππø∑
	lwz	r31, 0(r30)
	mtctr	r31
	bctrl
	subi	r3, r3, 104
...
judge_intersection.2762:
	...
	mr	r5, r7
	mr	r2, r8
	stw	r31, 4(r3) # ≥ «º§µ§Ï§ø•Í•Û•Ø•Ï•∏•π•ø§Œ√Õ§Ú•π•ø•√•Ø§À¿—§‡
	addi	r3, r3, 8 # •π•ø•√•Ø•›•§•Û•ø§Úππø∑
	lwz	r31, 0(r30)
	mtctr	r31
	bctrl
	subi	r3, r3, 8
...
beq_else.7985:
	...
	mr	r5, r8
	mr	r2, r6
	stw	r31, 60(r3) # ≥ «º§µ§Ï§ø•Í•Û•Ø•Ï•∏•π•ø§Œ√Õ§Ú•π•ø•√•Ø§À¿—§‡
	addi	r3, r3, 64 # •π•ø•√•Ø•›•§•Û•ø§Úππø∑
	lwz	r31, 0(r30)
	mtctr	r31
	bctrl
	subi	r3, r3, 64
...
beq_else.7992:
	...
	fmr	f1, f2
	fmr	f2, f3
	stw	r31, 108(r3) # ≥ «º§µ§Ï§ø•Í•Û•Ø•Ï•∏•π•ø§Œ√Õ§Ú•π•ø•√•Ø§À¿—§‡
	addi	r3, r3, 112 # •π•ø•√•Ø•›•§•Û•ø§Úππø∑
	lwz	r31, 0(r30)
	mtctr	r31
	bctrl
	subi	r3, r3, 112
...
trace_reflections.2794:
	...
	stw	r2, 60(r3)
	mflr	r31 # •Í•Û•Ø•Ï•∏•π•ø§Œ√Õ§Úr31§À∞Ïª˛≥ «º
	stw	r31, 68(r3) # ≥ «º§µ§Ï§ø•Í•Û•Ø•Ï•∏•π•ø§Œ√Õ§Ú•π•ø•√•Ø§À¿—§‡
	addi	r3, r3, 72 # •π•ø•√•Ø•›•§•Û•ø§Úππø∑
	lwz	r31, 0(r30)
	mtctr	r31
	bctrl
	subi	r3, r3, 72
...
trace_ray.2799:
	...
	mflr	r31 # •Í•Û•Ø•Ï•∏•π•ø§Œ√Õ§Úr31§À∞Ïª˛≥ «º
	mr	r2, r5
	stw	r31, 124(r3) # ≥ «º§µ§Ï§ø•Í•Û•Ø•Ï•∏•π•ø§Œ√Õ§Ú•π•ø•√•Ø§À¿—§‡
	addi	r3, r3, 128 # •π•ø•√•Ø•›•§•Û•ø§Úππø∑
	lwz	r31, 0(r30)
	mtctr	r31
	bctrl
	subi	r3, r3, 128
...
beq_else.8054:
	...
	stfd	f0, 152(r3)
	mflr	r31 # •Í•Û•Ø•Ï•∏•π•ø§Œ√Õ§Úr31§À∞Ïª˛≥ «º
	stw	r31, 164(r3) # ≥ «º§µ§Ï§ø•Í•Û•Ø•Ï•∏•π•ø§Œ√Õ§Ú•π•ø•√•Ø§À¿—§‡
	addi	r3, r3, 168 # •π•ø•√•Ø•›•§•Û•ø§Úππø∑
	lwz	r31, 0(r30)
	mtctr	r31
	bctrl
	subi	r3, r3, 168
...
beq_cont.8063:
	...
	stfd	f0, 176(r3)
	mflr	r31 # •Í•Û•Ø•Ï•∏•π•ø§Œ√Õ§Úr31§À∞Ïª˛≥ «º
	stw	r31, 188(r3) # ≥ «º§µ§Ï§ø•Í•Û•Ø•Ï•∏•π•ø§Œ√Õ§Ú•π•ø•√•Ø§À¿—§‡
	addi	r3, r3, 192 # •π•ø•√•Ø•›•§•Û•ø§Úππø∑
	lwz	r31, 0(r30)
	mtctr	r31
	bctrl
	subi	r3, r3, 192
	...
	lwz	r30, 32(r3)
	mflr	r31 # •Í•Û•Ø•Ï•∏•π•ø§Œ√Õ§Úr31§À∞Ïª˛≥ «º
	stw	r31, 196(r3) # ≥ «º§µ§Ï§ø•Í•Û•Ø•Ï•∏•π•ø§Œ√Õ§Ú•π•ø•√•Ø§À¿—§‡
	addi	r3, r3, 200 # •π•ø•√•Ø•›•§•Û•ø§Úππø∑
	lwz	r31, 0(r30)
	mtctr	r31
	bctrl
	subi	r3, r3, 200
...
beq_else.8111:
	...
	lwz	r30, 8(r3)
	mflr	r31 # •Í•Û•Ø•Ï•∏•π•ø§Œ√Õ§Úr31§À∞Ïª˛≥ «º
	stw	r31, 44(r3) # ≥ «º§µ§Ï§ø•Í•Û•Ø•Ï•∏•π•ø§Œ√Õ§Ú•π•ø•√•Ø§À¿—§‡
	addi	r3, r3, 48 # •π•ø•√•Ø•›•§•Û•ø§Úππø∑
	lwz	r31, 0(r30)
	mtctr	r31
	bctrl
	subi	r3, r3, 48
...
pretrace_pixels.2862:
	...
	mflr	r31 # •Í•Û•Ø•Ï•∏•π•ø§Œ√Õ§Úr31§À∞Ïª˛≥ «º
	mr	r5, r8
	stw	r31, 92(r3) # ≥ «º§µ§Ï§ø•Í•Û•Ø•Ï•∏•π•ø§Œ√Õ§Ú•π•ø•√•Ø§À¿—§‡
	addi	r3, r3, 96 # •π•ø•√•Ø•›•§•Û•ø§Úππø∑
	lwz	r31, 0(r30)
	mtctr	r31
	bctrl
	subi	r3, r3, 96
...
#	main program starts
	...
	li	r5, 512
	mflr	r31 # •Í•Û•Ø•Ï•∏•π•ø§Œ√Õ§Úr31§À∞Ïª˛≥ «º
	stw	r31, 148(r3) # ≥ «º§µ§Ï§ø•Í•Û•Ø•Ï•∏•π•ø§Œ√Õ§Ú•π•ø•√•Ø§À¿—§‡
	addi	r3, r3, 152 # •π•ø•√•Ø•›•§•Û•ø§Úππø∑
	lwz	r31, 0(r30)
	mtctr	r31
	bctrl
	subi	r3, r3, 152
