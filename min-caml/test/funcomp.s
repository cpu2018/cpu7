...
_min_caml_start:
	...
	lis	r5, lo16(dbl10)
	srwi	r5, r5, 31
	addi	r5, r5, ha16(dbl10)
	slwi	r5, r5, 16
	addi	r5, r5, lo16(dbl10)
	stw	r5, 0(r2)
	mr	r5, r4
	addi	r4, r4, 8
	lis	r6, lo16(inc12)
	srwi	r6, r6, 31
	addi	r6, r6, ha16(inc12)
	slwi	r6, r6, 16
	addi	r6, r6, lo16(inc12)
	stw	r6, 0(r5)
	mr	r6, r4
	addi	r4, r4, 8
	lis	r7, lo16(dec14)
	srwi	r7, r7, 31
	addi	r7, r7, ha16(dec14)
	slwi	r7, r7, 16
	addi	r7, r7, lo16(dec14)
	stw	r7, 0(r6)
	stw	r5, 0(r3)
	mflr	r31
	mr	r5, r6
...
compose7:
	mr	r6, r4
	addi	r4, r4, 16
	lis	r7, lo16(composed19)
	srwi	r7, r7, 31
	addi	r7, r7, ha16(composed19)
	slwi	r7, r7, 16
	addi	r7, r7, lo16(composed19)
	stw	r7, 0(r6)
	stw	r5, 8(r6)
	stw	r2, 4(r6)
	mr	r2, r6
