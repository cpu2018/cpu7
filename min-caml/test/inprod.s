...
_min_caml_start:
	...
	lis	r31, lo16(l64)
	srwi	r31, r31, 31
	addi	r31, r31, ha16(l64)
	slwi	r31, r31, 16
	addi	r31, r31, lo16(l64)
	lfd	f1, 0(r31)
	lis	r31, lo16(l65)
	srwi	r31, r31, 31
	addi	r31, r31, ha16(l65)
	slwi	r31, r31, 16
	addi	r31, r31, lo16(l65)
	lfd	f2, 0(r31)
	lis	r31, lo16(l66)
	srwi	r31, r31, 31
	addi	r31, r31, ha16(l66)
	slwi	r31, r31, 16
	addi	r31, r31, lo16(l66)
	lfd	f3, 0(r31)
	mr	r2, r4
	addi	r4, r4, 24
	stfd	f3, 16(r2)
	...
	lis	r31, lo16(l71)
	srwi	r31, r31, 31
	addi	r31, r31, ha16(l71)
	slwi	r31, r31, 16
	addi	r31, r31, lo16(l71)
	lfd	f1, 0(r31)
	lis	r31, lo16(l72)
	srwi	r31, r31, 31
	addi	r31, r31, ha16(l72)
	slwi	r31, r31, 16
	addi	r31, r31, lo16(l72)
	lfd	f2, 0(r31)
	lis	r31, lo16(l73)
	srwi	r31, r31, 31
	addi	r31, r31, ha16(l73)
	slwi	r31, r31, 16
	addi	r31, r31, lo16(l73)
	lfd	f3, 0(r31)
	mr	r5, r4
	addi	r4, r4, 24
	stfd	f3, 16(r5)
