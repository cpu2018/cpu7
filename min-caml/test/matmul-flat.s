...
_min_caml_start:
	...
	lis	r31, lo16(l274)
	srwi	r31, r31, 31
	addi	r31, r31, ha16(l274)
	slwi	r31, r31, 16
	addi	r31, r31, lo16(l274)
	lfd	f0, 0(r31)
	mflr	r31
	stw	r31, 4(r3)
	addi	r3, r3, 8
	...
	lis	r31, lo16(l280)
	srwi	r31, r31, 31
	addi	r31, r31, ha16(l280)
	slwi	r31, r31, 16
	addi	r31, r31, lo16(l280)
	lfd	f0, 0(r31)
	stfd	f0, 4(r2)
	lwz	r2, 0(r7)
	lis	r31, lo16(l283)
	srwi	r31, r31, 31
	addi	r31, r31, ha16(l283)
	slwi	r31, r31, 16
	addi	r31, r31, lo16(l283)
	lfd	f0, 0(r31)
	stfd	f0, 8(r2)
	lwz	r2, 4(r7)
	lis	r31, lo16(l286)
	srwi	r31, r31, 31
	addi	r31, r31, ha16(l286)
	slwi	r31, r31, 16
	addi	r31, r31, lo16(l286)
	lfd	f0, 0(r31)
	stfd	f0, 0(r2)
	lwz	r2, 4(r7)
	lis	r31, lo16(l289)
	srwi	r31, r31, 31
	addi	r31, r31, ha16(l289)
	slwi	r31, r31, 16
	addi	r31, r31, lo16(l289)
	lfd	f0, 0(r31)
	stfd	f0, 4(r2)
	lwz	r2, 4(r7)
	lis	r31, lo16(l292)
	srwi	r31, r31, 31
	addi	r31, r31, ha16(l292)
	slwi	r31, r31, 16
	addi	r31, r31, lo16(l292)
	lfd	f0, 0(r31)
	stfd	f0, 8(r2)
	lwz	r8, 8(r3)
	lwz	r2, 0(r8)
	lis	r31, lo16(l295)
	srwi	r31, r31, 31
	addi	r31, r31, ha16(l295)
	slwi	r31, r31, 16
	addi	r31, r31, lo16(l295)
	lfd	f0, 0(r31)
	stfd	f0, 0(r2)
	lwz	r2, 0(r8)
	lis	r31, lo16(l298)
	srwi	r31, r31, 31
	addi	r31, r31, ha16(l298)
	slwi	r31, r31, 16
	addi	r31, r31, lo16(l298)
	lfd	f0, 0(r31)
	stfd	f0, 4(r2)
	lwz	r2, 4(r8)
	lis	r31, lo16(l301)
	srwi	r31, r31, 31
	addi	r31, r31, ha16(l301)
	slwi	r31, r31, 16
	addi	r31, r31, lo16(l301)
	lfd	f0, 0(r31)
	stfd	f0, 0(r2)
	lwz	r2, 4(r8)
	lis	r31, lo16(l304)
	srwi	r31, r31, 31
	addi	r31, r31, ha16(l304)
	slwi	r31, r31, 16
	addi	r31, r31, lo16(l304)
	lfd	f0, 0(r31)
	stfd	f0, 4(r2)
	lwz	r2, 8(r8)
	lis	r31, lo16(l307)
	srwi	r31, r31, 31
	addi	r31, r31, ha16(l307)
	slwi	r31, r31, 16
	addi	r31, r31, lo16(l307)
	lfd	f0, 0(r31)
	stfd	f0, 0(r2)
	lwz	r2, 8(r8)
	lis	r31, lo16(l310)
	srwi	r31, r31, 31
	addi	r31, r31, ha16(l310)
	slwi	r31, r31, 16
	addi	r31, r31, lo16(l310)
	lfd	f0, 0(r31)
	stfd	f0, 4(r2)
	li	r2, 2
	li	r5, 3
