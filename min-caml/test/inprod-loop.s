...
_min_caml_start:
	...
	lis	r31, lo16(l39)
	srwi	r31, r31, 31
	addi	r31, r31, ha16(l39)
	slwi	r31, r31, 16
	addi	r31, r31, lo16(l39)
	lfd	f0, 0(r31)
	mflr	r31
	stw	r31, 4(r3)
	addi	r3, r3, 8
	...
	lis	r31, lo16(l40)
	srwi	r31, r31, 31
	addi	r31, r31, ha16(l40)
	slwi	r31, r31, 16
	addi	r31, r31, lo16(l40)
	lfd	f0, 0(r31)
	stw	r2, 0(r3)
	mflr	r31
	mr	r2, r5
	...
	lis	r31, lo16(l41)
	srwi	r31, r31, 31
	addi	r31, r31, ha16(l41)
	slwi	r31, r31, 16
	addi	r31, r31, lo16(l41)
	lfd	f0, 0(r31)
	lis	r31, lo16(l42)
	srwi	r31, r31, 31
	addi	r31, r31, ha16(l42)
	slwi	r31, r31, 16
	addi	r31, r31, lo16(l42)
	lfd	f1, 0(r31)
	li	r6, 2
	lwz	r2, 0(r3)
	stfd	f0, 8(r3)
