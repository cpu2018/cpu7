...
_min_caml_start:
	...
	li	r2, 1
	li	r5, 2
	lis	r6, lo16(min_caml_a)
	srwi	r6, r6, 31
	addi	r6, r6, ha16(min_caml_a)
	slwi	r6, r6, 16
	addi	r6, r6, lo16(min_caml_a)
	lwz	r6, 0(r6)
	mflr	r31
	stw	r31, 4(r3)
	addi	r3, r3, 8
